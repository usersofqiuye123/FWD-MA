      ...
      <div id="root">
          ...
          <div class="nav">
              <div class="nav-left">
                  ...
                  <h4>    Welcome to the AI-generated poster feature!</h4>
              </div>
              <div class="nav-right">
                  <ul>
          ...
          <div class="fixed-header">
              <div class="container">
                      ...
                      <div class="option">
                          ...
                          <div class="design-requirements">
                              ...
                              <div class="mod_text">
                                  ...
                                  <input type="number" id="length" min="1" step="1" placeholder="输入长度">
                                  <label for="width">宽度:</label>
                                  <input type="number" id="width" min="1" step="1" placeholder="输入宽度">
                  ...
                  <div class="product-container">
                      <div class="product">
                          <!-- 显示生成的图片 -->
                          <img src="../components/img/backgroud.jpg" alt="Generated Image" class="product-image">
                      </div>
                      <div class="mod">
